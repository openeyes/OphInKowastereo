...
class m140731_130010_pattern_details extends CDbMigration {

    public function safeUp() {

        // ********************************
        // change pattern_ocr to something else
        $this->createTable('et_ophinkowastereo_hvf_post_ocr', array(
            ...
            'PRIMARY KEY (`id`)',
            'KEY `et_ophinkowastereo_pattern_ocr_lmui_fk` (`last_modified_user_id`)',
            'KEY `et_ophinkowastereo_pattern_ocr_cui_fk` (`created_user_id`)',
            'CONSTRAINT `et_ophinkowastereo_pattern_ocr_lmui_fk` FOREIGN KEY (`last_modified_user_id`) REFERENCES `user` (`id`)',
            'CONSTRAINT `et_ophinkowastereo_pattern_ocr_cui_fk` FOREIGN KEY (`created_user_id`) REFERENCES `user` (`id`)',
                ), 'ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin');
		return true;
    }

    public function safeDown() {
        $this->dropTable('et_ophinkowastereo_pattern_ocr');
		return true;
    }
