...
class OphInKowastereo_Episode_KowaStereoHistory extends EpisodeSummaryWidget
{
	public function run()
	{
		$data = array();
		...
		foreach ($events as $event) {
			$element = $event->getElementByClass('Element_OphInKowastereo_Image');
		...
		Yii::app()->clientScript->registerScript(
			"OphInKowastereo_Episode_KowaStereoHistory_element_ids",
			"var OphInKowastereo_Episode_KowaStereoHistory_element_ids = " . CJSON::encode($element_ids),
