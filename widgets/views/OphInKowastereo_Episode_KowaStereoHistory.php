...
?>
<?php if ($elements): ?>
	<div id="ks-slider-container">
	<?php foreach ($elements as $element): ?>
		<div id="OphInKowastereo_Episode_KowaStereoHistory_element_<?= $element->id ?>" class="OphInKowastereo_Episode_KowaStereoHistory_element element-fields element-eyes hidden">
			<?php
	...
	<div id="OphInKowastereo_Episode_KowaStereoHistory_slider"></div>
	<script>
		$(document).ready(function () {

			var elementIds = window.OphInKowastereo_Episode_KowaStereoHistory_element_ids;
			var sliderContainer = $('#ks-slider-container');
			var slider = $('#OphInKowastereo_Episode_KowaStereoHistory_slider');
			var elements = $('.OphInKowastereo_Episode_KowaStereoHistory_element');
			...
			function showElement(elementId) {
				$('#OphInKowastereo_Episode_KowaStereoHistory_element_' + elementId).show();
			}
...
<?php else: ?>
	<div class="data-value">No stereo images recorded for this patient.</div>
<?php endif ?>
